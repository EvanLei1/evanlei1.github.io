<template>
  <div class="min-h-screen bg-gray-950 text-gray-100 flex flex-col justify-between">
    ...
    <main class="max-w-4xl mx-auto p-6 space-y-6">
      <h1 class="text-4xl font-extrabold tracking-tight text-white border-b border-gray-800 pb-4" align="center">Kern
        and Santa Barbara Counties Bus List</h1>
      <h2 class="text-3xl font-bold text-white pt-2" id="kernCounty">Kern County</h2>
      <h3 class="text-2xl font-semibold text-indigo-400" id="GET">Golden Empire Transit</h3>
      <h4 class="text-xl font-medium text-gray-200">Active Fleet</h4>
      <h5 class="text-lg font-medium text-gray-300">Old buses</h5>
      <ul class="list-disc list-inside space-y-1 text-gray-300 pl-2">
        <li><b><mark class="highlighted-cr">Critically endangered</mark></b> 12 2012 New Flyer C40LFR buses starting at
          1035
        </li>
        <li><b><mark class="highlighted-lc">Active</mark></b> 15 2013 New Flyer XN40 buses starting at 1047</li>
      </ul>
      ...
      <h3 class="text-2xl font-semibold text-indigo-400" id="KernTransit">Kern Transit</h3>
      <p class="text-gray-300 leading-relaxed">Most of the buses use either ElDorado National Axess BRT 35' or 40' in
        diesel or CNG, some Ford and
        Freightliner buses with or without CNG, and some BYD buses.
      </p>

      <h2 class="text-3xl font-bold text-white pt-2" id="SLOCounty">San Luis Obispo County</h2>
      <p class="text-gray-300 leading-relaxed">Under construction</p>

      <h2 class="text-3xl font-bold text-white pt-2" id="SBCounty">Santa Barbara County</h2>
      <p class="text-gray-300 leading-relaxed">Under construction</p>
      ...
      <div class="accordion-redlist">
        <details>
          ...
          <span class="Splatoon2">ex-SamTrans buses (2003) (7/17): 437-438, 440, 444-446, 450</span> <s></s><br>
        </details>
      </div>
      <div class="accordion-redlist">
        <details>
      ...
      <div class="accordion-redlist">
        <details>
          ...
          Kern County:
          <span class="Splatoon2">2600 series (10/10)</span><br>
        </details>
      </div>
      <div class="accordion-redlist">
        <details>
