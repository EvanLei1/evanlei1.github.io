    ...
    <div class="layout">
      ...
      <aside class="left-sidebar">
        <div class="sidebar-section">
          ...
          <ul>
            <li><a href="#SCMTD">Santa Cruz Metro</a></li>
            <li><a href="#SanBenito">San Benito County Express</a></li>
            <li><a href="#MST">Monterey-Salinas Transit</a></li>
      ...
      <main>
        <section>
          <h1 align="center">Santa Cruz Valley Bus List</h1>
          <h2 id="SCMTD">Santa Cruz Metro</h2>
          <h3>Active Fleet</h3>
          ...
          <ul>
            ...
            <ul>
              <li>The first 5 units were suburban configuration without a rear door</li>
            </ul>
          </ul>
          <ul>
          ...
          <ul>
            ...
            <ul>
              ...
              <li>Very rarely seen in service in Orange County, replaced by 2100 and 2200 series</li>
          ...
          <ul>
            ...
            <ul>
              <li>Ex-San Diego MTS units of the same numbers with a 0 placed in the middle, bought in
                2023.</li>
              <li>This series used in the hometown were retired between late 2023 and early 2025</li>
          ...
          <h2 id="SanBenito">San Benito County Express</h2>
          <p>Several cutaway buses were used on routes between Gilroy and San Benito County.</p>
