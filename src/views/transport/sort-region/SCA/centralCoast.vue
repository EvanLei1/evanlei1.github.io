        ...
        <div class="layout">
            ...
            <aside class="left-sidebar">
                <div class="sidebar-section">
                    ...
                    <ul>
                        <li><a href="Santa Cruz Metro">Santa Cruz Area Bus List</a></li>
                        <li>List</li>
                        <li><a href="#">List</a></li>
                        <li>List</li>
                    </ul>
            ...
            <main id="Santa Cruz Metro">
                <section>
                    ...
                    <h2>Santa Cruz Metro</h2>
                    <h3 id="AC Transit active fleet">Active Fleet</h3>
                    ...
                    <div class="responsive">
                        <div class="gallery">
                            <a target="_blank" href="/transport/files/2022/02/PXL_20220206_222524816.jpg">
                                <img src="/transport/files/2022/02/PXL_20220206_222524816.jpg" alt="SCMTD 2318"
                                    width="25%">
                            </a>
                            <div class="desc">Santa Cruz Metro 2318 at transit center</div>
                            <a target="_blank" href="/transport/files/2022/02/PXL_20220206_223140747.jpg">
                                <img src="/transport/files/2022/02/PXL_20220206_223140747.jpg" alt="SCMTD 9824"
                                    width="25%">
                            </a>
                            <div class="desc">Santa Cruz Metro 9824</div>
                            <a target="_blank" href="/transport/files/2023/05/PXL_20230529_014032875.jpg">
                                <img src="/transport/files/2023/05/PXL_20230529_014032875.jpg" alt="SCMTD 1612"
                                    width="25%">
                            </a>
