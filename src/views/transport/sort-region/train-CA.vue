<template>
  <div class="min-h-screen bg-gray-950 text-gray-100 flex flex-col justify-between">
    ...
    <main class="max-w-4xl mx-auto p-6 space-y-6">
      <h1 class="text-4xl font-extrabold tracking-tight text-white border-b border-gray-800 pb-4">California train list
      </h1>
      <p class="text-gray-300 leading-relaxed"><strong>NOTE:</strong> I am updating this page infrequently because I have to upload more images to my website.
      </p>
      <p class="text-gray-300 leading-relaxed">The bus list contained a variety of buses taken by myself within the United States and China. It was sorted by
        the region and when these photos are taken. For zero-emission vehicles, it will be found <router-link
          to="/transport/electricBus">here</router-link>.
      </p>
      <hr />
      <h2 class="text-3xl font-bold text-white pt-2" id="updates">Latest Updates</h2>
      <p class="text-gray-300 leading-relaxed"><strong>NOTE:</strong> I am updating this page infrequently because I have to upload more images to my
        website.</p>
      <p class="text-gray-300 leading-relaxed">This is a list of images of trains taken in California.</p>

      <h2 class="text-3xl font-bold text-white pt-2" id="NCA">Northern California</h2>
      <h3 class="text-2xl font-semibold text-indigo-400" id="BART">Bay Area Rapid Transit</h3>
      <p class="text-gray-300 leading-relaxed">BART trains entered service on September 11, 1972, starting with original Rohr trains, known as A and B cars.
        These cars were Refurbished between 1996 and 2002. Some A cars were converted to B cars. The C1 cars were made
        in 1985-1990, and were never refurbished, so it retired in May 2023. The C2 cars were made in 1994-1996 and
        retired in 2021 because of mechanical issues. The A and B cars were made in 1971-1975.
      </p>
      <p class="text-gray-300 leading-relaxed">The "Fleet of the Future" sets, also known as D and E sets, were delivered from 2012. The 465th car was
        delivered in July 2024, and expansion cars were delivered right now. The 1000th car out of 1129 was delivered on
        July 28, 2025. The 48 expansion cars were approved. The highest numbered car is 4690 as of July 29, 2025, but
        may go up to 4691, and the D sets only have 310 cars.
      </p>
      ...
      <h3 class="text-2xl font-semibold text-indigo-400" id="MUNI">San Francisco Municipal Railway</h3>
      <p class="text-gray-300 leading-relaxed">Muni operates both light rail fleet and streetcars in the city. Historic streetcars run on the F line while
      ...
      <h3 class="text-2xl font-semibold text-indigo-400" id="VTA">Santa Clara Valley Transportation Authority</h3>
      <p class="text-gray-300 leading-relaxed">VTA operates both light rail fleet and streetcars in the city. Historic streetcars run only in December in
        downtown.</p>
      <span class="Splatoon2"><mark class="highlighted-ex">Extinct</mark> UTDC cars: 0/50</span><br>
      <span class="Splatoon2"><mark class="highlighted-lc">Least Concern</mark> Kinki Sharyo LRV:
        100/100</span><br>
      <span class="Splatoon2"><mark class="highlighted-dd">Data deficient</mark> Historic streetcars:
        ?/7</span><br>

      <h3 class="text-2xl font-semibold text-indigo-400" id="SacRT">Sacramento Regional Transit District</h3>
      <p class="text-gray-300 leading-relaxed">SacRT operates light rail fleet within the city. There were three lines: the blue line goes from Cosumnes River
        College to Watt/I-80, the gold line from Sacramento Valley Station to Sunrise, and the green line from
        Sacramento Valley Station to Meadowview.
      </p>
      ...
      <h3 class="text-2xl font-semibold text-indigo-400" id="Caltrain">Caltrain</h3>
      <p class="text-gray-300 leading-relaxed">Caltrain is a commuter rail network serving from San Francisco to Gilroy. All of the Gallery cars, made in
        1985, and some of the Bombardier BiLevel cars were retired in 2024. The MP36PH-3C locomotives were retired in
        2023, and the MPXpress locomotives were retired in 2024. The new Stadler KISS trains are now in service, and the
        Bombardier BiLevel cars are still in service.
      </p>
      ...
      <span class="Splatoon2"><mark class="highlighted-nt">Near threatened</mark> F40PH locomotives:
        3/23</span><br>
      <span class="Splatoon2"><mark class="highlighted-lc">Least Concern</mark> MP36PH locomotives: 6/6</span><br>
      <h3 class="text-2xl font-semibold text-indigo-400" id="ACE">Altamont Corridor Express</h3>
      <!-- <p class="text-gray-300 leading-relaxed">Caltrain is a commuter rail network serving from San Francisco to Gilroy. All of the Gallery cars, made in 1985, and some of the Bombardier BiLevel cars
    ...
    The new Stadler KISS trains are now in service, and the Bombardier BiLevel cars are still in service.
      ...
      <h2 class="text-3xl font-bold text-white pt-2" id="SCA">Southern California</h2>
      <h3 class="text-2xl font-semibold text-indigo-400" id="LAMetro">Los Angeles Metro</h3>
      <!-- <p class="text-gray-300 leading-relaxed">BART trains entered service on September 11, 1972, starting with original Rohr trains, known as A and B cars. These cars were Refurbished
    ...
    <p class="text-gray-300 leading-relaxed">The "Fleet of the Future" sets, also known as D and E sets, were delivered from 2012. The 465th car was delivered in July 2024, and expansion cars were delivered right now.
    The highest numbered car is the 4640s, and the D sets only have 310 cars.
      ...
      <h3 class="text-2xl font-semibold text-indigo-400" id="OC">Orange County Transportation Authority</h3>
      <!-- <p class="text-gray-300 leading-relaxed">Muni operates both light rail fleet and streetcars in the city. Historic streetcars run on the F line while light rail vehicles run on other lines.</p> -->
      <span class="Splatoon2"><mark class="highlighted-lc">Least Concern</mark> Siemens S700: 1/8</span><br>

      <h3 class="text-2xl font-semibold text-indigo-400" id="MetroLink">Metrolink</h3>
      <!-- <p class="text-gray-300 leading-relaxed">VTA operates both light rail fleet and streetcars in the city. Historic streetcars run only in December in downtown.</p> -->
      ...
      <!-- <p class="text-gray-300 leading-relaxed">SacRT operates light rail fleet within the city. There were three lines: the blue line goes from Cosumnes River College to Watt/I-80, the gold line from -->
      ...
      <span class="Splatoon2"><mark class="highlighted-lc">Least Concern</mark> Siemens S70/S700:
        168/168</span><br>
      <span class="Splatoon2"><mark class="highlighted-dd">Data deficient</mark> PCC streetcars: ?/2</span><br>

      <h3 class="text-2xl font-semibold text-indigo-400" id="NCTD">North County Transit District</h3>
      <!-- <p class="text-gray-300 leading-relaxed">Caltrain is a commuter rail network serving from San Francisco to Gilroy. All of the Gallery cars, made in 1985, and some of the Bombardier BiLevel cars
    were retired in 2024. The MP36PH-3C locomotives were retired in 2023, and the MPXpress locomotives were retired in 2024.
    The new Stadler KISS trains are now in service, and the Bombardier BiLevel cars are still in service.
    </p> -->
    ...
    <span class="Splatoon2"><mark class="highlighted-lc">Least Concern</mark> MP36PH locomotives: 6/6</span><br> -->
      ...
      <h2 class="text-3xl font-bold text-white pt-2" id="AmtrakCA">Amtrak California</h2>
      <h3 class="text-2xl font-semibold text-indigo-400" id="CC">Capitol Corridor/Gold Runner</h3>
      <!-- <p class="text-gray-300 leading-relaxed">BART trains entered service on September 11, 1972, starting with original Rohr trains, known as A and B cars. These cars were Refurbished
    between 1996 and 2002. Some A cars were converted to B cars. The C1 cars were made in 1985-1990, and were never refurbished, so it retired in May 2023.
    The C2 cars were made in 1994-1996 and retired in 2021 because of mechanical issues. The A and B cars were made in 1971-1975.
    </p>
    ...
    <span class="Splatoon2"><mark class="highlighted-dd">On Order</mark> P3030: 0/33</span><br> -->
      ...
      <h3 class="text-2xl font-semibold text-indigo-400" id="PS">Pacific Surfliner</h3>
      <!-- <p class="text-gray-300 leading-relaxed">Muni operates both light rail fleet and streetcars in the city. Historic streetcars run on the F line while light rail vehicles run on other lines.</p> -->
